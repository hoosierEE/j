...
next =. 3 : '>{:;: y'
filenames =. ({."1 ]1!:0<'*.txt')
contents =. 1!:1 filenames
justNumberOf =. 3 : '>{:"1;: y'
nums =. justNumberOf contents
)
echo 'fifthRiddle'
echo fifthRiddle''
echo''
...
echo 'to exit the J terminal and return to the shell, type the following letters exactly as you see them below:'
echo '   exit'''''
